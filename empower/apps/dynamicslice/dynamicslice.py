...
from empower.managers.ranmanager.lvapp.lvappconnection import LVAPPConnection as LVC
...
class SliceStats(EWiFiApp):
    ...
    def handle_response(self, response, *_):
        ...
        if (condicion):
            LVC.send_set_slice() # FALSO creo que hay que hacer self.context.upsert_wifi_slice()
